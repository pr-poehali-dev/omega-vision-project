      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Есть идея, история или вопрос? Делитесь — мы читаем каждое письмо и рады живому общению
              с теми, кто разделяет любовь к красоте жизни.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ваша идея, вопрос или история..."
                  required
                />
              </div>
              <button
