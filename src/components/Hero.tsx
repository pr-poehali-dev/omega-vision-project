  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Жизнь,
          <span className="block text-sage">которая вдохновляет</span>
        </h1>
        ...
        >
          Идеи, советы и истории о том, как сделать каждый день красивее, осознаннее и радостнее. Для тех, кто ценит настоящее.
        </p>
