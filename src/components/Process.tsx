...
const steps = [
  {
    ...
    title: "Замечаем",
    description:
      "Красота начинается с внимания. Мы учимся видеть прекрасное в обычном — в утреннем свете, запахе кофе, случайной улыбке прохожего.",
  },
  {
    number: "02",
    title: "Исследуем",
    description:
      "Пробуем новое, задаём вопросы, ищем ответы. Каждая идея — это приглашение к маленькому эксперименту над собственной жизнью.",
  },
  {
    number: "03",
    title: "Делимся",
    description:
      "Собираем лучшее — советы, истории, открытия — и передаём тем, кто тоже хочет жить красиво, осмысленно и с удовольствием.",
  },
  {
    number: "04",
    title: "Растём",
    description:
      "Красота жизни — это путь, а не пункт назначения. Каждый день приносит новый опыт, новое понимание и новое вдохновение.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> к красоте</span>
              </h2>
              <p
              ...
              >
                Красивая жизнь не случается сама по себе. Она складывается из маленьких осознанных шагов,
                которые мы делаем каждый день вместе с вами.
              </p>
            </div>
          </div>
