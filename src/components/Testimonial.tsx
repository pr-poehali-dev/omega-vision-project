  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Этот журнал изменил то, как я смотрю на обычные дни. Я начала замечать красоту там, где раньше видела только рутину. Теперь каждое утро — это маленький праздник.
        </blockquote>
        ...
        >
          ...
          <p className="text-sm text-primary-foreground/60 mt-1">Читательница журнала</p>
        </div>
      </div>
    </section>
  )
